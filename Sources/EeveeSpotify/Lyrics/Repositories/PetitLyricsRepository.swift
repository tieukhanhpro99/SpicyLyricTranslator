...
class PetitLyricsRepository: LyricsRepository {
    ...
    func getLyrics(_ query: LyricsSearchQuery, options: LyricsOptions) throws -> LyricsDto {
        ...
        case .wordsSynced:
            ...
            let lines = lyrics.lines.compactMap { line -> LyricsLineDto? in
                guard let firstWord = line.words.first else {
                    return nil
                }

                return LyricsLineDto(
                    content: line.linestring,
                    offsetMs: firstWord.starttime
                )
            }
        ...
        case .plain:
            ...
            let lines = stringLyrics.lyricsLines
